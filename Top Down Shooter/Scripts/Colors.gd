...
extends Node
var img : Image
@export var hover_color_enemy : Color = Color(1,0,0)
@export var hover_color_neutral : Color = Color(1,1,0)
@export var hover_color_ally : Color = Color(0,1,0)
...
@export var player_colors : PackedColorArray = [
	...
	set(value):
		img = Image.create(Config.MAX_PLAYERS,1,false,Image.FORMAT_RGBA8)
		player_colors = value
		var i = 0
